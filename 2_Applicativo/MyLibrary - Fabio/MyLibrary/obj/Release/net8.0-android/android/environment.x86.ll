...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 350072970, ; hash 0x14ddb08a, from name: aot-MyLibrary
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1621700435, ; hash 0x60a92f53, from name: libaot-MyLibrary.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 166
	...
	%struct.DSOCacheEntry {
		i64 1663573275, ; hash 0x63281d1b, from name: MyLibrary
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 175
	...
	%struct.DSOCacheEntry {
		i64 2324928441, ; hash 0x8a9397b9, from name: MyLibrary.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 256
	...
	%struct.DSOCacheEntry {
		i64 3957523393, ; hash 0xebe303c1, from name: aot-MyLibrary.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 444
	...
	%struct.DSOCacheEntry {
		i64 4225976528, ; hash 0xfbe348d0, from name: libaot-MyLibrary
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 474
