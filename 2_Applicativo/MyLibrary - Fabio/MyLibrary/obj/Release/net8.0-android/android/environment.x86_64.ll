...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 10214777617575676901, ; hash 0x8dc22e1f7b358be5, from name: libaot-MyLibrary
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 254
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 12678877174555029206, ; hash 0xaff46b9d5c292ed6, from name: MyLibrary.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 323
	...
	%struct.DSOCacheEntry {
		i64 13193197832230315232, ; hash 0xb717a787218aa4e0, from name: libaot-MyLibrary.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 339
	...
	%struct.DSOCacheEntry {
		i64 14590665872249734289, ; hash 0xca7c754e5fdc4491, from name: aot-MyLibrary.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 379
	...
	%struct.DSOCacheEntry {
		i64 16914774459982637209, ; hash 0xeabd59c0c71d6899, from name: aot-MyLibrary
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 440
	...
	%struct.DSOCacheEntry {
		i64 18089639044417943756, ; hash 0xfb0b4ede2d9178cc, from name: MyLibrary
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyLibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 466
...
@.env.3 = private unnamed_addr constant [37 x i8] c"d75c77ea-147a-4295-899f-7f5102e12b73\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.mylibrary\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [24 x i8] c"libaot-MyLibrary.dll.so\00", align 16
